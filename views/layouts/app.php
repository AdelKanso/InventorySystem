...
<body>
    <div id="wrapper">
        ...
        <?php
        if ($page != 'login') {
            echo "<nav class='navbar navbar-default navbar-static-top' role='navigation' style='margin-bottom:0;background-color:#337ab7;padding-bottom:13px;padding-top:12px;'>";
